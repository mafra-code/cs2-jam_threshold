    ...
    public class LocaleZHHans : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.RateText)), "全部对象" },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.CarRateText)), "汽车" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.DeliveryTruckRateText)), "配送卡车" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.GarbageTruckRateText)), "垃圾车" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.CargoTruckRateText)), "货运卡车" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.RoadMaintenanceRateText)), "道路养护" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.ParkMaintenanceRateText)), "公园养护" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.MaintenanceRateText)), "养护车辆" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.FireEngineRateText)), "消防车" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.PoliceCarRateText)), "警车" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.PostVanRateText)), "邮政车" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.AmbulanceRateText)), "救护车" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.HearseRateText)), "灵车" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.PrisonerTransportRateText)), "囚犯运输" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.EvacuationRateText)), "疏散车辆" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.TaxiRateText)), "出租车" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.TransitRateText)), "公共交通" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.PassengerTrainRateText)), "客运列车" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.CargoTrainRateText)), "货运列车" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.TrainRateText)), "列车" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.AirplaneRateText)), "飞机" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.HelicopterRateText)), "直升机" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.AircraftRateText)), "航空器" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.WatercraftRateText)), "船只" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.BicycleRateText)), "自行车" },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.EnableDebugging)), "在 Mods_JamThreshold.log 中写入详细卡住日志。开启时会拖慢游戏。关闭以恢复正常速度。" },
