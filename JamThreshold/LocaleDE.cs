    ...
    public class LocaleDE : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.RateText)), "Alle Objekte" },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.CarRateText)), "Autos" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.DeliveryTruckRateText)), "Lieferwagen" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.GarbageTruckRateText)), "Müllwagen" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.CargoTruckRateText)), "Fracht-Lkw" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.RoadMaintenanceRateText)), "Straßenwartung" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.ParkMaintenanceRateText)), "Parkwartung" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.MaintenanceRateText)), "Wartungsfahrzeuge" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.FireEngineRateText)), "Feuerwehr" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.PoliceCarRateText)), "Polizeiwagen" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.PostVanRateText)), "Postwagen" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.AmbulanceRateText)), "Krankenwagen" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.HearseRateText)), "Leichenwagen" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.PrisonerTransportRateText)), "Gefangenentransport" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.EvacuationRateText)), "Evakuierungsfahrzeuge" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.TaxiRateText)), "Taxis" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.TransitRateText)), "ÖPNV" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.PassengerTrainRateText)), "Personenzüge" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.CargoTrainRateText)), "Güterzüge" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.TrainRateText)), "Züge" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.AirplaneRateText)), "Flugzeuge" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.HelicopterRateText)), "Hubschrauber" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.AircraftRateText)), "Luftfahrzeuge" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.WatercraftRateText)), "Wasserfahrzeuge" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.BicycleRateText)), "Fahrräder" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.PedestrianRateText)), "Fußgänger" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.OtherRateText)), "Sonstige" },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.EnableDebugging)), "Ausführliche Feststeck-Logs in Mods_JamThreshold.log. Bremst das Spiel, solange an. Für normale Geschwindigkeit aus." },
