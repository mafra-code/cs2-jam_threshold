    ...
    public class LocaleKO : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { m_Setting.GetOptionGroupLocaleID(Setting.kRateGroup), "속도" },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.RateText)), "모든 오브젝트" },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.CarRateText)), "승용차" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.DeliveryTruckRateText)), "배송 트럭" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.GarbageTruckRateText)), "쓰레기 트럭" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.CargoTruckRateText)), "화물 트럭" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.RoadMaintenanceRateText)), "도로 정비" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.ParkMaintenanceRateText)), "공원 정비" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.MaintenanceRateText)), "정비 차량" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.FireEngineRateText)), "소방차" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.PoliceCarRateText)), "경찰차" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.PostVanRateText)), "우편 밴" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.AmbulanceRateText)), "구급차" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.HearseRateText)), "영구차" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.PrisonerTransportRateText)), "수감 수송" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.EvacuationRateText)), "대피 차량" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.TaxiRateText)), "택시" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.TransitRateText)), "대중교통" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.PassengerTrainRateText)), "여객 열차" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.CargoTrainRateText)), "화물 열차" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.TrainRateText)), "열차" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.AirplaneRateText)), "비행기" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.HelicopterRateText)), "헬리콥터" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.AircraftRateText)), "항공기" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.WatercraftRateText)), "선박" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.BicycleRateText)), "자전거" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.PedestrianRateText)), "보행자" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.OtherRateText)), "기타" },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.EnableDebugging)), "Mods_JamThreshold.log에 자세한 정체 로그를 기록합니다. 켜져 있으면 게임이 느려집니다. 정상 속도를 위해 끄세요." },
